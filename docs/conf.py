...
htmlhelp_basename = 'uncertain_pandadoc'
...
latex_documents = [
    (master_doc, 'uncertain_panda.tex', 'uncertain\\_panda Documentation',
     'Nils Braun', 'manual'),
]
...
man_pages = [
    (master_doc, 'uncertain_panda', 'uncertain_panda Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'uncertain_panda', 'uncertain_panda Documentation',
     author, 'uncertain_panda', 'One line description of project.',
     'Miscellaneous'),
]
